...
//        Mat src = Imgcodecs.imread("src/images/test.tif");
        ...
        // TODO 这里要测试一下！！！
        double[][] arrList = new double[100][100];
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            Scalar color2 = new Scalar(105, 105, 105);
...
//            Imgproc.circle(src, centerList.get(i), radiusList.get(i), color2, 1, Imgproc.LINE_AA, 0);
            ...
            * */
            ...
            arrList[i][0] = centerList.get(i).x;
            arrList[i][1] = centerList.get(i).y;
//            System.out.println("x:" + arrList[i][0] + "," + "y:" + arrList[i][1]);
            String str = "("+arrList[i][0] + ", "+arrList[i][1]+")";

            Imgproc.circle(src, centerList.get(i), 1, color2, 1, Imgproc.LINE_AA);
            Imgproc.putText(src, str, new Point(arrList[i][0], arrList[i][1]), 1, 1, new Scalar(105, 105, 105), 1);
